...
> [!TIP]
> For a step-by-step walkthrough, including prerequisites, troubleshooting and guidance on reading the results, see **[Running an inventory](docs/running-an-inventory.md)**.
